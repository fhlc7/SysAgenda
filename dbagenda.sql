...
CREATE TABLE `contato` (`id` int(11) NOT NULL PRIMARY KEY, `nome` varchar(255) NOT NULL, `fone` varchar(20) DEFAULT NULL, `email` varchar(255) DEFAULT NULL, `endereco` blob );
